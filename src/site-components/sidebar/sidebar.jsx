                ...
                <nav className="iq-sidebar-menu">
                    <ul id="iq-sidebar-toggle" className="iq-menu">
                        <li className="active active-menu">
                            <a href="#dashboard" className="iq-waves-effect" data-toggle="collapse" aria-expanded="true"><span
                                className="ripple rippleEffect"></span><i className="las la-home iq-arrow-left"></i><span>Shop</span><i
                            ...
                            <ul id="dashboard" className="iq-submenu collapse show" data-parent="#iq-sidebar-toggle">
                                <li className="active"><a href="index-2.html"><i className="las la-house-damage"></i>Home Page</a></li>
                                <li><a href="category.html"><i className="ri-function-line"></i>Category Page</a></li>
                                <li><a href="book-page.html"><i className="ri-book-line"></i>Book Page</a></li>
                                <li><a href="book-pdf.html"><i className="ri-file-pdf-line"></i>Book PDF</a></li>
                                <li><a href="Checkout.html"><i className="ri-checkbox-multiple-blank-line"></i>Checkout</a></li>
                                <li><a href="wishlist.html"><i className="ri-heart-line"></i>wishlist</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="#admin" className="iq-waves-effect" data-toggle="collapse" aria-expanded="false"><span
                                className="ripple rippleEffect"></span><i className="ri-admin-line"></i><span>Admin</span><i
                                    className="ri-arrow-right-s-line iq-arrow-right"></i></a>
                            <ul id="admin" className="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                                <li><a href="admin-dashboard.html"><i className="ri-dashboard-line"></i>Dashboard</a></li>
                                <li><a href="admin-category.html"><i className="ri-list-check-2"></i>Category Lists</a></li>
                                <li><a href="admin-author.html"><i className="ri-file-user-line"></i>Author</a></li>
                                <li><a href="admin-books.html"><i className="ri-book-2-line"></i>Books</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="#userinfo" className="iq-waves-effect" data-toggle="collapse" aria-expanded="false"><span
                                className="ripple rippleEffect"></span><i className="las la-user-tie iq-arrow-left"></i><span>User</span><i
                                    className="ri-arrow-right-s-line iq-arrow-right"></i></a>
                        ...
                        <li>
                            <a href="#ui-elements" className="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="false"><i
                                className="lab la-elementor iq-arrow-left"></i><span>UI Elements</span><i
                                    className="ri-arrow-right-s-line iq-arrow-right"></i></a>
                            <ul id="ui-elements" className="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                                <li className="elements">
                                    <a href="#sub-menu" className="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="false"><i
                                        className="ri-play-circle-line"></i><span>UI Kit</span><i
                                            className="ri-arrow-right-s-line iq-arrow-right"></i></a>
                                ...
                                <li className="form">
                                    <a href="#forms" className="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="false"><i
                                        className="lab la-wpforms"></i><span>Forms</span><i
                                            className="ri-arrow-right-s-line iq-arrow-right"></i></a>
                                ...
                                <li>
                                    <a href="#wizard-form" className="iq-waves-effect collapsed" data-toggle="collapse"
                                        aria-expanded="false"><i className="ri-archive-drawer-line"></i><span>Forms Wizard</span><i
                                            className="ri-arrow-right-s-line iq-arrow-right"></i></a>
                                    <ul id="wizard-form" className="iq-submenu collapse" data-parent="#ui-elements">
                                        ...
                                        <li><a href="form-wizard-vertical.html"><i className="ri-anticlockwise-line"></i>Vertical Wizard</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="#tables" className="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="false"><i
                                ...
                                <li>
                                    <a href="#charts" className="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="false"><i
                                        className="ri-pie-chart-box-line"></i><span>Charts</span><i
                                            className="ri-arrow-right-s-line iq-arrow-right"></i></a>
                                ...
                                <li>
                                    <a href="#icons" className="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="false"><i
                        ...
                        <li>
                            <a href="#pages" className="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="false"><i
                                className="las la-file-alt iq-arrow-left"></i><span>Pages</span><i
                                    className="ri-arrow-right-s-line iq-arrow-right"></i></a>
                            <ul id="pages" className="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                                <li>
                                    <a href="#authentication" className="iq-waves-effect collapsed" data-toggle="collapse"
                                ...
                                <li>
                                    <a href="#extra-pages" className="iq-waves-effect collapsed" data-toggle="collapse"
                        ...
                        <li>
                            <a href="#menu-level" className="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="false"><i
                                className="ri-record-circle-line iq-arrow-left"></i><span>Menu Level</span><i
                                    className="ri-arrow-right-s-line iq-arrow-right"></i></a>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        <li className="menu-level">
                                            <a href="#sub-menus" className="iq-waves-effect collapsed" data-toggle="collapse"
                                                aria-expanded="false"><i className="ri-play-circle-line"></i><span>Sub-menu</span><i
                                                    className="ri-arrow-right-s-line iq-arrow-right"></i></a>
                    ...
                    <div className="iq-card">
                        <div className="iq-card-body">
                            <div className="sidebarbottom-content">
                                ...
                                <button type="submit" className="btn w-100 btn-primary mt-4 view-more">Become Membership</button>
                            </div>
                        </div>
                    </div>
                </div>
